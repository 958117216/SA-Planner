...
private:
  ...
  Eigen::Vector3d origin_, map_size_3d_,end_;
  double time_origin_;
  ...
  double getEuclHeuristic(Eigen::VectorXd x1, Eigen::VectorXd x2);
  /* state propagation */
...
public:
  ...
  enum { REACH_HORIZON = 1, REACH_END = 2, NO_PATH = 3, REACH_BOUNDARY = 4 };
